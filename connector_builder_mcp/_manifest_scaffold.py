...
def _generate_manifest_yaml_directly(
    ...
    paginator_yaml = _generate_paginator_yaml(pagination_type)
...
streams:
  - type: DeclarativeStream
    ...
    primary_key:
      - {primary_key}  # TODO: Update with actual primary key field from your API
    retriever:
      ...
      record_selector:
        ...
        extractor:
          type: DpathExtractor
          field_path: {record_selector_path}  # TODO: Update after examining API response structure
{paginator_yaml}
      schema_loader:
...
"""
    ...
    manifest_yaml += incremental_sync_section
...
def _generate_paginator_yaml(pagination_type: PaginationType) -> str:
    ...
    if pagination_type == PaginationType.NONE:
        return """      paginator:
        type: NoPagination
      # TODO: Uncomment and configure pagination when needed
      # paginator:
...
def create_connector_manifest_scaffold(
    ...
    *,
    ...
    try:
        ...
        primary_key = "TODO"
        record_selector_path: list[str] = []
        pagination_type_enum = PaginationType.NONE
        ...
        manifest_yaml = _generate_manifest_yaml_directly(
            ...
            record_selector_path=record_selector_path,
            pagination_type=pagination_type_enum,
        )
