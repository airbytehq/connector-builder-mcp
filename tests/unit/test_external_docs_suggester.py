...
class TestDeriveVendorDomain:
    """Tests for vendor domain derivation."""
    ...
    def test_derive_vendor_domain(self, api_name, api_base_url, vendor_domain, expected):
        result = _derive_vendor_domain(api_name, api_base_url, vendor_domain)
        assert result == expected


class TestIsOfficialDomain:
    """Tests for official domain checking."""
    ...
    def test_is_official_domain(self, url, vendor_domain, expected):
...
class TestScoreUrl:
    ...
    def test_score_official_domain(self):
        score = _score_url(
            "https://docs.stripe.com/api",
            "api_reference",
            "stripe.com",
        ...
        assert score > 50.0  # Should get domain bonus

    def test_score_preferred_subdomain(self):
        score = _score_url(
            "https://docs.stripe.com/api",
            "api_reference",
            "stripe.com",
        ...
        assert score >= 70.0  # Should get domain + subdomain bonus

    def test_score_path_pattern_match(self):
        score = _score_url(
        ...
        assert score >= 80.0  # Should get domain + subdomain + path pattern bonus

    def test_score_penalize_locale(self):
...
class TestCanonicalizeUrl:
    ...
    def test_canonicalize_url(self, url, expected):
...
class TestGenerateCanonicalTitle:
    ...
    def test_generate_canonical_title(self, vendor_name, category, expected):
        result = _generate_canonical_title(vendor_name, category)
        assert result == expected


class TestAreUrlsSimilar:
    """Tests for URL similarity checking."""
    ...
    def test_are_urls_similar(self, url1, url2, expected):
